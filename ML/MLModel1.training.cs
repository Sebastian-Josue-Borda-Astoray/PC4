...
namespace practica4.ML
{
    public partial class MLModel1
    {
        public const string RetrainFilePath =  @"C:\Users\ADMIN\Desktop\Nueva carpeta (2)\practica4\ML\traingingdata\sentiment-data.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col1",outputColumnName:@"col1")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(new LbfgsMaximumEntropyMulticlassTrainer.Options(){L1Regularization=0.25345004F,L2Regularization=0.11426613F,LabelColumnName=@"col0",FeatureColumnName=@"Features"}))      
